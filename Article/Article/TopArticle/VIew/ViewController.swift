...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func navigateToDetails(result: Article) {
        ...
        guard let detailsViewController = storyboard.instantiateViewController(withIdentifier: "ArticleViewController") as? ArticleViewController else {
            print("Could not find view controller with Storyboard ID: ArticleViewController")
            return
        }
